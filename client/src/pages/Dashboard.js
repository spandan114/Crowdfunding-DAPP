...
const Dashboard = () => {
  return (
    <div className="px-2 py-6 flex flex-col lg:px-12 lg:flex-row ">
      <div className="lg:w-7/12 my-2 lg:my-0 lg:mx-2">
        {projects.map((data, i) => (
          <div className="card relative overflow-hidden my-2">
      ...
      <div className="card lg:w-5/12 h-fit">
          <p>Form</p>
      </div>
    </div>
  );
